    ...
    <div class="row justify-content-center">
        ...
        @if (session('message'))
            ...
            <div class="card">
                ...
                <a href="{{route('kasus2.create')}}" class="float-right btn btn-outline-primary">Tambah Data Kasus</a>
            </div>
                    ...
                    <thead>
                     <tr class="bg-info">
                      <th scope="col">No</th>
                                            ...
                                            <th scope="col"><center>RW/RT</center></th>
                                    ...
                                    @foreach($kasus2 as $data)
                                        ...
                                        <tr>
                                            ...
                                            <td><center> Provinsi : {{$data->rw->kelurahan->kecamatan->kota->provinsi->nama_provinsi}}<br>
                                                         Kota : {{$data->rw->kelurahan->kecamatan->kota->nama_kota}}<br>
                                                         Kecamatan : {{$data->rw->kelurahan->kecamatan->nama_kecamatan}}<br>
                                                         Kelurahan : {{$data->rw->kelurahan->nama_kelurahan}}</center></td>
